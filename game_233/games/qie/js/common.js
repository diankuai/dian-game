...
;~function(bt){
	...
	bt.URL = {
		root: "http://app.gzlankong.com/200game"
		,getMoreGame: function(){
			// 点击更多
			bt.dc("more");
			
			return "http://app.gzlankong.com/200game";
		}
		,getConcern: function(){
			return "http://mp.weixin.qq.com/s?__biz=MzAwNDIwOTQzMw==&mid=203006700&idx=1&sn=c48306f4bcbf3d1efe4de7296d509442#rd";
		}
