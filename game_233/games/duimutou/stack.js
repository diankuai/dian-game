...
var tite="";
	var DFW = {
		appId: "",
		TLImg: "http://app.gzlankong.com/200game/games/duimutou/icon.png",
		url: "http://app.gzlankong.com/200game/games/duimutou/",
		title: "堆木头，简单的不得了，好玩的停不下",
		desc: "玩法简单，但是玩的是技巧，反应，没有最高只有更高，来挑战下--关注杭州吃喝玩乐:hangzhouchihe"
	};
...
function updateShare(stscore) {
	imgUrl = 'http://app.gzlankong.com/200game/games/duimutou/i/icon.png';
	lineLink = 'http://app.gzlankong.com/200game/games/duimutou';
