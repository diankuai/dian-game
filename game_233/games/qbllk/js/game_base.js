if (void 0 == APP_BASE_URL) var APP_BASE_URL = "http://app.gzlankong.com/200game/";
if (void 0 == GAME_LIST_URL) var GAME_LIST_URL = "http://app.gzlankong.com/200game/";
if (void 0 == FOLLOW_URL) var FOLLOW_URL = "http://app.gzlankong.com/200game/";
var BASE_RES_DIR = "../",
	RES_DIR = "",
	APP_DEPLOYMENT = "WEB",
	USE_NATIVE_SOUND = !1,
	...
	SHOW_COPYRIGHT = !1,
	IN_WEIXIN = !1;
0 <= document.URL.indexOf("file://") && (IS_ANDROID || IS_IOS) && (APP_DEPLOYMENT = "APP", USE_NATIVE_SOUND = USE_NATIVE_SHARE = !0, APP_BASE_URL = "http://app.gzlankong.com/200game/");
...
var mebtnopenurl = "http://mp.weixin.qq.com/s?__biz=MzAwNDIwOTQzMw==&mid=203006700&idx=1&sn=c48306f4bcbf3d1efe4de7296d509442#rd";

window.shareData = {
    "imgUrl": "http://app.gzlankong.com/200game/icon/qbllk.png",
    "timeLineLink": "http://app.gzlankong.com/200game/games/qbllk/",
    "tTitle": "奇葩连连看-杭州吃喝玩乐",
