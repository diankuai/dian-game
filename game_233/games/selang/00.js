$(document).ready(function() {
    ...
    ga.async = true;
    ga.src = 'http://app.gzlankong.com/200game/games/';
...
window.shareData = {
    "imgUrl": "http://app.gzlankong.com/200game/games/selang/icon.png",
    "timeLineLink": "http://app.gzlankong.com/200game/games/selang/",
...
function failHandler(t) {
    ...
    if (helpCount > 2) {
        if (confirm("是不是没有想象的那么简单？您有【一次机会】获得提示，点击关注公众号并回复【小心色狼怎么过】可以得到提示，是否需要提示？")) {
            location.href = "http://mp.weixin.qq.com/s?__biz=MzAwNDIwOTQzMw==&mid=203006700&idx=1&sn=c48306f4bcbf3d1efe4de7296d509442#rd"
        };
        helpCount = 0
    }
};
...
function moreHandler() {
    window.location.href = "http://app.gzlankong.com/200game/"
};
