	...
	ck: function() {
		function a() {
			function a(c) {
				b.invoke(c, {
					appid: y.Lh,
					img_url: "http://app.gzlankong.com/200game",
					img_width: "200",
					img_height: "200",
					link: y.url(),
					desc: y.Rc.$h(),
					...
					document.location="http://app.gzlankong.com/200game";
				})
			}
...
var y = y || {};
y.Lh = "";
y.domain = "http://app.gzlankong.com/200game";
y.url = function() {
	return "http://app.gzlankong.com/200game?u="+ Math.floor(Math.random()*10000000);
};
y.qj = "http://app.gzlankong.com/200game/mtl";
y = y || {};
y.game = "game.html";
y.Rc = {
	...
	ctor: function() {
		...
		function(a) {
			...
			var c = new y.c.Uc("+关注", "ma_button_blue", function() {
				location.href = "http://app.gzlankong.com/200game"
			}, this);
