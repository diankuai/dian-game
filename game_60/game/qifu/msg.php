...
<div class="btn">
    <a href="http://app.gzlankong.com/game/qifu/qifu/">我也要祈福</a><!--http://192.168.1.188/2 替换为你的域名例如http://game.id87.com/zhufu/index.htm-->
</div>
<!--编辑区域 end-->
<div class="aa">
    <div class="bb">
        ...
        <table width="100%" height="100%" border="0">
          <tr>
            <td align="center" valign="middle"><a href="app.gzlankong.com"><img src="http://app100620636.qzone.qzoneapp.com/wap_hly/public/resource/assets/h_logo.png" /></a></td>
          </tr>
        </table>
      </div>
        <div class="rt">
            <table width="100%" height="100%" border="0">
              <tr>
                <td align="center" valign="middle"><a href="http://mp.weixin.qq.com/s?__biz=MzAwNDIwOTQzMw==&mid=203006700&idx=1&sn=c48306f4bcbf3d1efe4de7296d509442#rd
" class="btn">关注我们</td>
              </tr>
            </table>
        </div>
        ...
        <table width="100%" height="100%" border="0">
          <tr>
            <td align="center" valign="middle"><a href="http://app.gzlankong.com/" style="color:#fff;">更多游戏<Br />自定义内容自定义内容！</a></td>
          </tr>
        </table>
        </div>
    </div>
